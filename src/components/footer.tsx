        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
              The all-in-one school management platform built for modern
              Nigerian institutions. Digitize administration, improve learning
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/roadmap" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  Roadmap
                </Link>
              </li>
              <li>
                <Link to="/updates" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  Updates
                </Link>
              </li>
              */}
